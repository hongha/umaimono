  ...
  <div class="w3-row">
      ...
      <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
          <div class="w3-row-padding" style="margin:0 -16px">
            <div class="w3-half">
              <img src="{{ URL::asset('public/img/lights.jpg') }}" style="width:100%" alt="Northern Lights" class="w3-margin-bottom">
            </div>
            <div class="w3-half">
              <img src="{{ URL::asset('public/img/lights.jpg') }}"" style="width:100%" alt="Nature" class="w3-margin-bottom">
          </div>
        </div>
    ...
    <div class="w3-col m2">
      <div class="w3-card-2 w3-round w3-white w3-center">
        <div class="w3-container">
          <p>Upcoming Events:</p>
          <img src="{{ URL::asset('public/img/lights.jpg') }}" alt="Forest" style="width:100%;">
      ...
      <div class="w3-card-2 w3-round w3-white w3-center">
        <div class="w3-container">
          <p>Friend Request</p>
          <img src="{{ URL::asset('public/img/avatar.png') }}" alt="Avatar" style="width:50%"><br>
          <span>Jane Doe</span>
