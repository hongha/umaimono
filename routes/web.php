...
Route::group(['prefix' => 'shopper', 'middleware' => 'shopper'], function () {
    ...
    Route::get('delete_order/{id}', 'UserController@delete_order');
    Route::post('delete_order/{id}', 'UserController@delete_order');
...
Route::group(['prefix' => 'post'], function () {
    ...
    Route::get('reset_menu/{id}', 'PostController@reset_menu');
    Route::post('reset_menu/{id}', 'PostController@reset_menu');
    ...
    Route::get('buy/{id}', 'PostController@buy');
    Route::post('buy/{id}', 'PostController@buy');
    Route::post('order/{id}', 'PostController@order');
    Route::get('order/{id}', 'PostController@order');
    Route::post('add_ghi_chu/{id_food}', 'PostController@add_ghi_chu');
    Route::get('create_comment_post/{id}', 'PostController@create_comment_post');
    Route::post('create_comment_post/{id}', 'PostController@create_comment_post');
    Route::get('delete_comment_post/{id}', 'PostController@delete_comment_post');
    Route::post('delete_comment_post/{id}', 'PostController@delete_comment_post');
    Route::get('edit_comment_post/{id}', 'PostController@edit_comment_post');
    Route::post('edit_comment_post/{id}', 'PostController@edit_comment_post');
    Route::get('getResFoods/{id}', 'PostController@getResFoods');
    Route::post('getResFoods/{id}', 'PostController@getResFoods');
    Route::get('view_restaurant/{id}', 'PostController@view_restaurant');
    Route::post('view_restaurant/{id}', 'PostController@view_restaurant');
    Route::get('create_comment_food/{id}', 'PostController@create_comment_food');
    Route::post('create_comment_food/{id}', 'PostController@create_comment_food');
    Route::get('delete_comment_food/{id}', 'PostController@delete_comment_food');
    Route::post('delete_comment_food/{id}', 'PostController@delete_comment_food');
    Route::get('edit_comment_food/{id}', 'PostController@edit_comment_food');
    Route::post('edit_comment_food/{id}', 'PostController@edit_comment_food');
});
